namespace TISFAT
{
	partial class DownloadUpdateDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Download Speed: 4.3 MB/s";
			...
			this.label2.Text = "An update is being downloaded. TISFAT will close and run the installer when done." +
    "";
			...
			this.Text = "Downloading TISFAT Zero Update..";
